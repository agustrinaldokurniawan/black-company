...
def help_text() -> str:
    return (
        ...
        "• **/runproj** / **/stopproj** — run projects via `.black-company-run.toml`; stop background runs.\n"
        "• **/setenv** — merge into a project’s `.env` from chat (next message = `KEY=value` lines); **/cancelsetenv**.\n\n"
